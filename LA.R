...
myDF <- read.csv("/class/datamine/data/airbnb/united-kingdom/england/london/2019-07-10/visualisations/.csv")
...
register_google(key = "AIzaSyCsonMpQN92mXp86653aDMvs-uS2LlXf6Q", write = TRUE)
